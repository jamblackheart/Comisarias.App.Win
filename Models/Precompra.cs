...
namespace Comisarias.App.Escritorio.Models
{
    public class Precompra
    {
        ...
        //public decimal MontoPlatinoPropio { get; set; }
        ...
        //public decimal ValorPagarPropios { get; set; }

        public int SedeId { get; set; }
        public string Estado { get; set; }

        public string DocCompliance { get; set; }
        public decimal CupoDisponibleCompra { get; set; }
        ...
        public Precompra(string cedula)
        {
            Cedula = cedula;
        }
        public Precompra()
