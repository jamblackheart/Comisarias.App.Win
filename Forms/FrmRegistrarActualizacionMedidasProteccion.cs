...
namespace Comisarias.App.Escritorio.Forms
{
    public partial class FrmRegistrarActualizacionMedidasProteccion : Form
    {
        ...
        ActualizacionMedidasProteccion objRegistro = new ActualizacionMedidasProteccion();
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (ValidarDatos())
            {
                ...
                if (usuario.Id > 0)
                {
                    Respuesta respuesta = controlador_actualizacionMedidasProteccion.AgregarRegistro(objRegistro);
                    if (respuesta.FueExitosa)
                    {
