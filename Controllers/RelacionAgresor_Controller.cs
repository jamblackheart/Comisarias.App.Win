...
{
    public class RelacionAgresor_Controller
    {
        ...
        public RespuestaGetDatos ObtenerTodos()
        {
            ...
            try
            {
                ...
                {
                    con.Open();
                    using (SqlCommand command = new SqlCommand(@"SELECT * FROM RelacionAgresor", con))
                    {
        ...
        public Respuesta EliminarRegistro(string id)
        {
            ...
            try
            {
                ...
                {
                    con.Open();
                    using (SqlCommand command = new SqlCommand(@"DELETE RelacionAgresor WHERE Id = @pId", con))
                    {
        ...
        public Respuesta AgregarRegistro(string nombre)
        {
            Respuesta retorno = new Respuesta();
            retorno.FueExitosa = false;
            retorno.Mensaje = "validando...";
            ...
            try
            {
                ...
                {
                    con.Open();
                    using (SqlCommand command = new SqlCommand(@"INSERT INTO RelacionAgresor VALUES (@pNombre)", con))
                    {
        ...
        public Respuesta ActualizarRegistro(string id, string nombre)
        {
            Respuesta retorno = new Respuesta();
            retorno.FueExitosa = false;
            retorno.Mensaje = "validando...";
            ...
            try
            {
                ...
                {
                    con.Open();
                    using (SqlCommand command = new SqlCommand(@"UPDATE RelacionAgresor SET Nombre = @pNombre WHERE Id = @pId", con))
                    {
                        SqlParameter pId = new SqlParameter("@pId", SqlDbType.VarChar);
                        SqlParameter pNombre = new SqlParameter("@pNombre", SqlDbType.VarChar);
