...
{
    public class MedidasProteccion_Controller
    {
        ...
        public RespuestaGetDatos ObtenerTodos()
        {
            ...
            try
            {
                ...
                {
                    con.Open();
                    using (SqlCommand command = new SqlCommand(@"SELECT * FROM MedidasProteccion", con))
                    {
        ...
        public Respuesta ActualizarRegistro(string id, string nombreMedidasProteccion)
        {
            Respuesta retorno = new Respuesta();
            retorno.FueExitosa = false;
            retorno.Mensaje = "validando...";
            ...
            try
            {
                ...
                {
                    con.Open();
                    using (SqlCommand command = new SqlCommand(@"UPDATE MedidasProteccion SET Nombre = @pNombre WHERE Id = @pId", con))
                    {
                        SqlParameter pId = new SqlParameter("@pId", SqlDbType.VarChar);
                        SqlParameter pNombre = new SqlParameter("@pNombre", SqlDbType.VarChar);

                        pId.Value = id;
                        pNombre.Value = nombreMedidasProteccion;
